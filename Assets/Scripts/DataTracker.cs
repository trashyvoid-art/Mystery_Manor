...
public class DataTracker : MonoBehaviour
{
    ...
    Sailor_Int_DialogueCode sean = new Sailor_Int_DialogueCode();
    Ms_Scheele_Int_DialogueCode scheele = new Ms_Scheele_Int_DialogueCode();
    Doctor_Int_DialogueCode sanchez = new Doctor_Int_DialogueCode();
    Adventurer_Int_DialogueCode sam = new Adventurer_Int_DialogueCode();
    Psych_Body_DialogueCode scarlette = new Psych_Body_DialogueCode();
