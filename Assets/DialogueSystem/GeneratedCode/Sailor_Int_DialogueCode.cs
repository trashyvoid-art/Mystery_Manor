...
GameObject scene = GameObject.Find("SceneManager");
        ...
        public void Start()
        {
            ...
            eventFunctions.Add("Sailor_Int_2d033398c21e46e69a92845e0fc99651",Sailor_Int_2d033398c21e46e69a92845e0fc99651);
            ...
            eventFunctions.Add("Sailor_Int_d82a02f2ddba42079dd80df4cc07b457",Sailor_Int_d82a02f2ddba42079dd80df4cc07b457);
...
GameObject.FindObjectOfType<AudioManager>().Play("Next Line");
GameObject.FindObjectOfType<AudioManager>().Play("Sean Accuse 2");
        }
        // Event From Node: 54c362f7-5b86-4475-864c-c155a4bf8450 //
        public void Sailor_Int_54c362f75b864475864cc155a4bf8450() {
GameObject.FindObjectOfType<AudioManager>().Play("Next Line");
GameObject.FindObjectOfType<AudioManager>().Play("Sean Accuse 3");
        }
...
GameObject.FindObjectOfType<AudioManager>().Play("Next Line");
GameObject.FindObjectOfType<AudioManager>().Play("Sean FB 5");
        }
...
GameObject.FindObjectOfType<AudioManager>().Play("Next Line");
GameObject.FindObjectOfType<AudioManager>().Play("Scarlett FB 1");
        }
...
GameObject.FindObjectOfType<AudioManager>().Play("Next Line");
GameObject.FindObjectOfType<AudioManager>().Play("Sean FB 2");
        }
        // Event From Node: 2d033398-c21e-46e6-9a92-845e0fc99651 //
        public void Sailor_Int_2d033398c21e46e69a92845e0fc99651() {
GameObject.FindObjectOfType<AudioManager>().Play("Next Line");
GameObject.FindObjectOfType<AudioManager>().Play("Sean Accuse 4");
        }
        // Event From Node: 7163d3ee-5c3d-49e3-8998-85541a7bc25b //
        public void Sailor_Int_7163d3ee5c3d49e3899885541a7bc25b() {
GameObject.FindObjectOfType<AudioManager>().Play("Next Line");
GameObject.FindObjectOfType<AudioManager>().Play("Sean FB 1");
        }
...
dt.showBackgroundImage += 1;
        ...
        // Event From Node: d82a02f2-ddba-4207-9dd8-0df4cc07b457 //
        public void Sailor_Int_d82a02f2ddba42079dd80df4cc07b457() {
GameObject.FindObjectOfType<AudioManager>().Play("Next Line");
        }
